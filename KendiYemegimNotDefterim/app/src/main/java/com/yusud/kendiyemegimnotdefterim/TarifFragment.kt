package com.yusud.kendiyemegimnotdefterim
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if(gelenBilgi.equals("menudengeldim")){
                //yeni bir yemek eklemey geldi
                textYemekkismi.setText("")
                textYemekmalzeme.setText("")
                ...
                //daha önceden olusturulan yemegı gormeye geldı
                ...
                context?.let {
                    try{
                        ...
                        while(cursor.moveToNext()){
                            textYemekkismi.setText(cursor.getString(yemekIsmiIndex))
                            textYemekmalzeme.setText(cursor.getString(yemekMalzemeIndex))
    ...
    fun kaydet(view : View){
        //SQLite kaydedilcek
        val yemekIsmi = textYemekkismi.text.toString()
        val yemekMalzemeleri = textYemekmalzeme.text.toString()
    ...
    fun gorselSec(view : View){
        ...
        activity?.let {
            if(ContextCompat.checkSelfPermission(it.applicationContext,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    //İzin verilmedi, istenilcek
                    requestPermissions(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE),1)

                }else{
                    //İzin verilmiş, tekrar istemeden galeriye git.
